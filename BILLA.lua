...
SUDO = SUDO
sudo_users = {SUDO,1914327324,1994261730}   
print([[
▄▄▄▄▄▄▄▄▄▄  ▄▄▄▄▄▄▄▄▄▄▄  ▄            ▄            ▄▄▄▄▄▄▄▄▄▄▄ 
▐░░░░░░░░░░▌▐░░░░░░░░░░░▌▐░▌          ▐░▌          ▐░░░░░░░░░░░▌
▐░█▀▀▀▀▀▀▀█░▌▀▀▀▀█░█▀▀▀▀ ▐░▌          ▐░▌          ▐░█▀▀▀▀▀▀▀█░▌
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/SRC-BILLA/Files_BILLA/main/File_Bot/commands.lua") 
...
if tonumber(user_id) == tonumber(1914327324) then  
var = true  
elseif tonumber(user_id) == tonumber(1994261730) then
var = true  
...
local UserName = (data.username_ or "EE92i")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼┇𝘴𝘰𝘳𝘶𝘤𝘦 𝘣𝘪𝘭𝘭𝘢.")  
...
function plugin_BILLA(msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.BILLA and msg then
pre_msg = plugin.BILLA(msg)
end
end
end
...
--------------------------------------------------------------------------------------------------------------
function SourceBILLA(msg,data) -- بداية العمل
if msg then
...
vardump(data)
if data and data.messages[0].content_sticker_ then
...
if text =='تغيير المطور الاساسي ⇇◍⇉' and DevSoFi(msg) then
send(msg.chat_id_, msg.id_,'*⇇◍⇉ ارسل ايدي المطور الاساسي الجديد*')
database:set(bot_id..'Ed:DevBots',true) 
end
if text =='تغيير المطور الاساسي ⇇◍⇉' and not DevSoFi(msg) then
send(msg.chat_id_, msg.id_,'*⇇◍⇉لا يمكنك تغيير المطور الاساسي*')
end
if text == 'تحديث السورس ⇇◍⇉' and DevSoFi(msg) then 
os.execute('rm -rf BILLA.lua')
os.execute('wget https://raw.githubusercontent.com/BILLASR/BILLA/main/BILLA.lua')
...
usertext = '\n⇇◍⇉العضو » ['..result.title_..'](t.me/'..(username or 'EE92i')..')'
status  = '\n⇇◍⇉تم ترقيته مطور'
...
if BILLA1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'⇇◍⇉العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'EE92i')..') \n⇇◍⇉'..BILLA1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0,"⇇◍⇉العضو : {["..data.first_name_.."](T.ME/EE92i)}\n⇇◍⇉["..BILLA_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "⇇◍⇉عذرا » {["..data.first_name_.."](T.ME/EE92i)}\n⇇◍⇉عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if name_MRSOFI then 
names_MRSOFI = database:smembers(bot_id.."BILLA:blocname"..msg.chat_id_) or ""
...
if mrsofi2.first_name_:match("(.*)"..database:get(bot_id.."BILLA:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."BILLA:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrsofi_nnn = database:get(bot_id.."BILLA:nump"..msg.chat_id_) or 5
local mrsofi_nnn2 = database:get(bot_id.."BILLA:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'⇇◍⇉بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'EE92i')..') \n⇇◍⇉تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'⇇◍⇉بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'EE92i')..') \n⇇◍⇉تـم قفـل التاك بالكتم ')
end,nil)   
...
if text == 'العاب بيلا' or text == 'العاب اونلاين' or text == 'العاب' then  
local Text = [[  
 ◍ اهلا في قائمه الالعاب المتطوره سورس بيلا ◍ 
...
{{text = '  𖣘 ⁽SＯＵＲＣＥ₎ 𖣘 ', url="t.me/EE28i"}},
}  
local msg_id = msg.id_/2097152/0.5  
...
local Text = "⇇◍⇉ منشئ الكروب  ⋙ ["..b.first_name_.."](tg://user?id="..b.id_..")\n"..getbio(b.id_):gsub('لايوجد','')
local msg_id = msg.id_/2097152/0.5
keyboard = {} 
keyboard.inline_keyboard = {
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n⇇◍⇉لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'EE92i')..')'
status  = '\n⇇◍⇉تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n⇇◍⇉العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n⇇◍⇉العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'EE92i')..')'
...
local msg_id = msg.id_/2097152/0.5 
local Text = [[ 
 مطــور آݪبــٰٰٰ๋ٖٖٖۧ͜ــ۫͜ــــوت
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
...
t = "\n⇇◍⇉قائمة المنع \nٴ⩹━━━◍『ʙᴇʟʟᴀ』◍━━━⩺ٴ\n"
for k,v in pairs(list) do  
local BILLA_Msg = database:get(bot_id.."BILLA1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..BILLA_Msg.."}\n"    
end  
if #list == 0 then  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n⇇◍⇉العضو » ['..result.title_..'](t.me/'..(text1[3] or 'EE92i')..')'..'\n⇇◍⇉تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
------------------------------------------------------------------------
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:BILLA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\n⇇◍⇉ارسل الكلمه تريد اضافتها')
database:set(bot_id.."botss:BILLA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:BILLA:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:BILLA:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:BILLA:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"⇇◍⇉ تم حذف الرد من ردود المتعدده")
database:del(bot_id..'botss:BILLA:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:BILLA:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:BILLA:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:BILLA:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:BILLA:List:Rd:Sudo", text)
return false
end
end
...
local list = database:smembers(bot_id.."botss:BILLA:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:BILLA:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:BILLA:Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:BILLA:Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:BILLA:List:Rd:Sudo")
end
...
keyboard = {}  
keyboard.inline_keyboard = {
{{text = '🖨┇𝘴𝘰𝘳𝘶𝘤𝘦 𝘣𝘪𝘭𝘭𝘢', url="https://t.me/EE28i"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
database:set(bot_id.."EE92i:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⇇◍⇉ تم تفعيل الانستا')
database:set(bot_id.."EE92i:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."EE92i:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."EE92i:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"⇇◍⇉تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."EE92i:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."EE92i:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس بيلايعني لو بكتهن راح اعرفك انت الاخذتهن
...
database:set(bot_id.."botss:BILLA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
...
database:set(bot_id.."botss:BILLA:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"⇇◍⇉ارسل الان الكلمه لحذفها ")
end
if text then  
local test = database:get(bot_id.."botss:BILLA:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:BILLA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:BILLA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:BILLA:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:BILLA:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:BILLA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:BILLA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:BILLA:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:BILLA:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:BILLA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:BILLA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:BILLA:Add:Rd:Sudo:Text2"..test, text)  
end  
...
if text then
local Text = database:get(bot_id.."botss:BILLA:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:BILLA:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:BILLA:Add:Rd:Sudo:Text2"..text)   
...
------------------------------------------------------------------------
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'بيلا').." غادر" or text == 'بوت غادر' then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'EE92i')..')'
local iduser = result.sender_user_id_
...
{{text = '🖨┇𝘴𝘰𝘳𝘶𝘤𝘦 𝘣𝘪𝘭𝘭𝘢', url="t.me/EE92i"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
{
{text = '𝑩𝑰𝑳𝑳𝑨 𝑪𝑯𝑨𝑵𝑵𝑬𝑳', url="t.me/EE92i"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
send(msg.chat_id_, msg.id_, t..'ٴ*ٴ⩹━━━◍『ʙᴇʟʟᴀ』◍━━━⩺ٴ*\n⇇◍⇉ ➫ .[🖨┇𝘴𝘰𝘳𝘶𝘤𝘦 𝘣𝘪𝘭𝘭𝘢](t.me/EE92i)➤ ')
end
